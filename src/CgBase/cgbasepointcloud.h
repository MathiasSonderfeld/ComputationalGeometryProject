#ifndef CG_BASE_POINT_CLOUD_H
#define CG_BASE_POINT_CLOUD_H
...
{
public:
    ~ CgBasePointCloud() override = default;
    ...
    virtual const glm::vec3 getClosestPoint(const glm::vec3& origin, const glm::vec3& dir, double maxDistance) const =0;
